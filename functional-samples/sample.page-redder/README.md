...
This sample demonstrates how to use [action API](https://developer.chrome.com/docs/extensions/reference/api/action) to execute code when the icon extension is clicked.
