...
const run = async () => {
  ...
  outputParts.push('// DO NOT EDIT THIS FILE DIRECTLY.');
  outputParts.push(
    '// This file is generated by running `npm run prepare-chrome-types`'
  );
  outputParts.push('');
  outputParts.push(JSON.stringify(result, null, 2));
  await fs.writeFile(
