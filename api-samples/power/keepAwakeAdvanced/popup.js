...
/**
 * Get an HTML element by selector asserts not null, and casts to HTMLElement.
 * @param {string} query
 * @return {HTMLElement}
 */
...
async function onload() {
  ...
  // Sync max value between code and HTML.
  ...
  // Note that button IDs and message IDs are based on the StateEnum values.
